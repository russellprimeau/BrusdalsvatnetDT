...
rem set CONDAPATH=C:\Users\russelbp\AppData\Local\anaconda3
rem Define here the name of the environment
rem set ENVNAME=dfm_tools_env
...
C:\Users\russelbp\GitHub\BrusdalsvatnetDT\venv\Scripts\python.exe ScrapeWeather.py
