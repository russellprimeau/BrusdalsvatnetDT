...
def hourly():
    ...
    if not selected_variables:
        ...
        st.markdown("##### Have you found a bug? Or do you have an idea for how to improve the app? Log suggestions at [link](https://github.com/russellprimeau/BrusdalsvatnetDT/issues)")
