...
def hourly():
    ...
    if not selected_variables:
        ...
        st.write("Find a bug? Or have an idea for how to improve the app? Please log suggestions at the [link](https://github.com/russellprimeau/BrusdalsvatnetDT/issues)")
